...
class WinningLottosTest {
    ...
    private LottoTicket thirdRankLottoTicket1;
    private LottoTicket thirdRankLottoTicket2;
    private LottoTicket otherRankLottoTicket;
    ...
    void 로또개수만큼_winningLottos가_만들어지는가() {
        //given
        WinningLottos winningLottos = WinningLottos.createWith(lottoTickets, lottoResult, bonusNumber);
    ...
    void winningLottos가_적절한_WinningLotto를_생성해내는가() {
        ...
        winningStatistics.add(WinningLotto.FOURTH);
        winningStatistics.add(WinningLotto.FOURTH);
    ...
    void WinningLotto의_개수를_잘계산하는가_() {
        ...
        //when
        int countOfThird = winningLottos.countWinningLotto(WinningLotto.FOURTH);
    ...
    void EarningRate를_잘_계산하고있는가() {
        //given
        double totalPrizeMoney = WinningLotto.FOURTH.getPrizeMoney() * 2;
